...
struct L10n {
    ...
    private static let translations: [String: [String: String]] = [
        ...
        "choose_mode": ["de": "Modus wählen", "en": "Choose Mode"],
        "choose_mode_subtitle": ["de": "Wähle aus, ob du gegen den Bot oder einen Freund spielen möchtest.", "en": "Choose if you want to play against the bot or a friend."],
        "play_against_bot": ["de": "Gegen Bot spielen", "en": "Against Bot"],
        "play_against_friend": ["de": "Gegen Freund spielen", "en": "Against Friend"],
        "bot_mode_desc": ["de": "Spiele gegen den Computer mit einstellbarer Spielstärke.", "en": "Play against the computer with adjustable strength."],
        "friend_mode_desc": ["de": "Spiele gegen einen Freund am selben Gerät.", "en": "Play against a friend on the same device."],
        "allow_hints": ["de": "Hinweise erlauben", "en": "Allow Hints"],
        "show_best_moves_retro": ["de": "Beste Züge nachträglich anzeigen", "en": "Show Best Moves Retrospectively"],
        "flip_board_after_moves": ["de": "Brett nach Zügen drehen", "en": "Flip Board after Moves"],
        "setup_friend_title": ["de": "Gegen einen Freund", "en": "Against a Friend"],
        "setup_friend_subtitle": ["de": "Tritt gegen einen Freund an und reicht das Handy weiter.", "en": "Compete against a friend and pass the phone."],
        ...
        "increment_seconds": ["de": "Bonuszeit (Sekunden)", "en": "Bonus Time (Seconds)"],
        ...
        // Onboarding
        "onboarding_welcome": ["de": "Willkommen bei\nChess Companion", "en": "Welcome to\nChess Companion"],
        "onboarding_subtitle": ["de": "Lass uns dein Profil einrichten. Dein Name erscheint während des Spiels.", "en": "Let's set up your profile. Your name is shown during games."],
        "onboarding_name_title": ["de": "Dein Name", "en": "Your Name"],
        "onboarding_name_placeholder": ["de": "Name eingeben", "en": "Enter your name"],
        "onboarding_elo_title": ["de": "Deine Chess.com-Wertung", "en": "Your Chess.com Rating"],
        "onboarding_elo_unknown": ["de": "Ich kenne meine Wertung nicht", "en": "I don't know my rating"],
        "onboarding_continue": ["de": "Los geht's", "en": "Get Started"],

        // Profile Tab
        "profile": ["de": "Profil", "en": "Profile"],
        "profile_subtitle": ["de": "Deine Statistiken, Wertung und Fortschritt.", "en": "Your stats, rating and progress."],
        "profile_avg_rating": ["de": "Ø Rating", "en": "Avg Rating"],
        "profile_avg_accuracy": ["de": "Ø Genauigkeit", "en": "Avg Accuracy"],
        "profile_games_played": ["de": "Challenge-Spiele", "en": "Challenge Games"],
        "profile_rating_trend": ["de": "Rating-Verlauf", "en": "Rating Over Time"],
        "profile_accuracy_trend": ["de": "Genauigkeits-Verlauf", "en": "Accuracy Over Time"],
        "profile_no_stats": ["de": "Noch keine Statistiken", "en": "No stats yet"],
        "profile_no_stats_desc": ["de": "Spiele ein Challenge-Spiel, um deine Wertung und Genauigkeit aufzubauen.", "en": "Play a Challenge game to build your rating and accuracy."],
        "profile_elo_unknown": ["de": "Unbekannt", "en": "Unknown"],
        "your_profile": ["de": "Dein Profil", "en": "Your Profile"],
        "chesscom_rating": ["de": "Chess.com-Wertung", "en": "Chess.com Rating"],

        // Challenge Mode
        "challenge_mode": ["de": "Challenge", "en": "Challenge"],
        "challenge_mode_desc": ["de": "Spiel ohne Hilfen – keine Bewertungsleiste, kein Elo, keine Zug-Analyse. Baut deine echte Wertung & Genauigkeit auf.", "en": "Play with no assistance – no eval bar, no Elo, no move analysis. Builds your real rating & accuracy."],
        "challenge_assist_locked": ["de": "Im Challenge-Modus sind alle Hilfen deaktiviert.", "en": "All assistance is disabled in Challenge mode."],
        "normal_game": ["de": "Normal", "en": "Normal"],
    ]
}
